...
export const createPost = () => {
  ...
  if (userPost === null) {
    //si no encuentra el nombre de usuario usa el email
    userName = userPost.email;
  }

  let photoUser = userPost.photoURL; //foto de usuario
  if (userPost.photoURL === null) {
    //solo toma foto de usuario cuando accede con google o facebook
  ...
  db.collection("comments")
    .add({
      //add para que firestore genere id de comentario
      nombre: userName,
      email: userEmail,
