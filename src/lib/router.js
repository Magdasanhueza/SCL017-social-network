...
export const changeRouter = (hash) => {
  //exportar const que ira cambiando las rutas a main
  if (hash === "#/") {
...
const templateView = (hash) => {
  //const que va pintando interfaz dependiendo el hash
  ...
  switch (
    hash //switch evalua los hash y presenta el correspondiente
  ) {
    case "#/":
